<template>
  <!-- Main -->
  <div @click.stop="app.toggleRunning()" w="auto xl:15 md:15 sm:15" h="30 xl:15 md:15 sm:15" bg="b-80 " p="4 xl:6 sm:8" m="3" border="4 transparent rounded-lg active:success-500" flex="~ col" justify="center" items="center" un-text="w-70 hover:white active:white" transition="~ 0.2s all" cursor="pointer" transform="~ active:scale-110" position="relative">
    <!-- Icon -->
