<template>
    <div bg="w-100" p="3" dark:bg-gradient="to-r from-black to-b-90" w="sm" border="~ rounded-3xl b-10 dark:w-20">
        <div flex="~ col" m="10" text="right">
            ...
            <div class="flex flex-col mt-5 space-y-6">
                <UiInput v-model="model" icon="i-clarity-email-solid dark:text-gray-400" label="البريد الالكتروني" placeholder="ادخل البريد الالكتروني" type="text" />
                <UiInput v-model="model" icon="i-clarity-lock-solid dark:text-gray-400" label="كلمة السر " placeholder="ادخل كلمة السر" type="password" />
