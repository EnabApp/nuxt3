  ...
  <div container="none" my="10%">
    ...
    >
        ...
        <div>
          <div flex="~ col gap-8px">
            ...
            <div
              ...
              hover="secondaryOp dark:bg-secondary"
              duration="200"
              rounded="10px"
              w="190px lg:270px"
              h="50px"
      ...
      <div
        ...
        justify="center"
        items="center"
        bg="primary dark:primaryOp opacity-50 dark:opacity-50"
      ...
      >
        ...
        <nuxt-link decoration="none" to="/auth/register">
          <span text="primaryOp dark:primary" cursor="pointer"
            >لا تمتلك حساب؟</span
          >
        </nuxt-link>
      </div>
